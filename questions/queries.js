const db = { questions: {} } //for eslint


// Insertions
db.questions.insert({ title : 'What is nodejs', correctAnswer : 'A JavaScript runtime environment', answers : [ 'A JavaScript runtime environment', 'A c# extension ', 'Irish children\'s story' ], difficulty: 4 })

db.questions.insert({ title :  'What is recursion in a programming language', correctAnswer : 'A technique to iterate over an operation by having a function call itself repeatedly until it arrives at a result.', answers : ['When a senior tells you to rewrite your function', 'A technique to iterate over an operation by having a function call itself repeatedly until it arrives at a result', 'When you get up in the morning and miraculously your bug is fixed' ], difficulty: 3 })
